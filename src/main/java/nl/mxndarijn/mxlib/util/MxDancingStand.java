    ...
    public void start(ArmorStand stand, DanceType type) {
        ...
        task = new BukkitRunnable() {
            ...
            @Override public void run() {
                if (MxDancingStand.this.stand == null || !MxDancingStand.this.stand.isValid()) {
                    cancel(); return;
                }
                // Dispatch style
                styles.getOrDefault(danceType, styles.get(DanceType.WAVE)).accept(t, MxDancingStand.this);
                t++;
            }
